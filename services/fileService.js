...
exports.createModel = function(object){
    ...
    var path = 'D:/tmp/';
    var filename = path.concat(object.table.replace(/\b\w/g, function(l){ return l.toUpperCase() }), '.js');
    ...
    object.columns.forEach(function(column){
         var field = "{name: '";
         _file.write(field.concat(column.name, "' type: '", utils.getType(column.type), "'},")) // again
    })
    _file.write("]")
